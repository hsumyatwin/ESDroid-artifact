...
public class FLiADDmin3 {
	...
	//static String location = "C:\\Users\\Heather\\eclipse-workspace\\FLiAD\\testData\\AnkiDroid\\";
    ...
    static String exceptionType="NumberFormatException";
    static String className="MainActivity";
    static int lineNumber=117;
    ...
    Process process;
	    try{
	         // process = Runtime.getRuntime().exec(new String[]{file,"arg1","arg2"});
	          process = Runtime.getRuntime().exec("C:\\Users\\Heather\\AppData\\Local\\Android\\Sdk\\tools\\monkeyrunner.bat "+file);
	          mProcess = process;
	    }catch(Exception e) {
